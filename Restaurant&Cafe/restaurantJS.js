async function nilbelDurumuGuncelle() {
    const yuzdeMetni = document.getElementById('nilbel-yuzde');
    const dolulukBari = document.getElementById('nilbel-bar');
    
    try {
        
        const response = await fetch('Restoran1/canli_durum.json');
